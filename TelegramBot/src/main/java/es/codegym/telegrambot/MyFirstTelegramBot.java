...
public class MyFirstTelegramBot extends MultiSessionTelegramBot {
    ...
    public static final String NAME = "JUANPEDRO";
    public static final String TOKEN = "6951348976:AAGsUlRmvVFOSzlk84neKRotav8HGPlQyus";
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_2_btn")) {
            ...
            sendTextMessageAsync(STEP_3_TEXT,
                    Map.of("Hackear al robot aspirador + 30 de fama", "step_3_btn"));
        ...
        if (getCallbackQueryButtonKey().equals("step_4_btn")) {
            ...
            sendTextMessageAsync(STEP_5_TEXT,
                    Map.of("Ponerte y encender la GoPro...", "step_5_btn"));
